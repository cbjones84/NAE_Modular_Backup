...
Source: spawnaga/Tensorflow_reinforcement_learning_trade_-ES_Options/Train_model.py
Implemented: 2025-12-09T10:58:27.068813
Usefulness Score: 100
Keywords: def , class , optimize, calculate, tensorflow, sklearn, model, train, predict, fit, gradient, loss, var, size, loss
"""

# Original source: spawnaga/Tensorflow_reinforcement_learning_trade_-ES_Options
# Path: Train_model.py
...
# Function: get_strikes_and_expiration
def get_strikes_and_expiration(self):
        ES = Future(symbol='ES', lastTradeDateOrContractMonth='20201218', exchange='GLOBEX',
                    currency='USD')
        ib.qualifyContracts(ES)
