...
Source: rlindland/options-market-making/bot.py
Implemented: 2025-12-09T09:58:19.112228
Usefulness Score: 100
Keywords: def , class , fit, volatility, position
"""

# Original source: rlindland/options-market-making
# Path: bot.py
...
# Function: make_better_call_market
def make_better_call_market(self, msg, order):
        for i in range(41):
            c_option = 'T' + str(int(i + 80)) + 'C'
            p_option = 'T' + str(int(i + 80)) + 'P'
...
# Function: make_better_put_market
def make_better_put_market(self, msg, order):
        for i in range(41):
            c_option = 'T' + str(int(i + 80)) + 'C'
            p_option = 'T' + str(int(i + 80)) + 'P'
